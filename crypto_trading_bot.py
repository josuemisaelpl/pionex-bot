...
CONFIG = {
    ...
    'initial_balance_usdt': float(os.getenv('INITIAL_BALANCE_USDT', 23.062)),
    'trade_quantity_btc': float(os.getenv('TRADE_QUANTITY_BTC', 0.00007)),
    'trade_quantity_eth': float(os.getenv('TRADE_QUANTITY_ETH', 0.001)),
